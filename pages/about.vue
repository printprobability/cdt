...
const members = ref([
  ...
  {src: 'img/lemley.jpg', name: 'Sam Lemley', degree: 'Carnegie Mellon University Libraries', roles: ['Editorial & Technical Team', 'Frontend design']},
  ...
  {src: 'img/henry.jpg', name: 'Henry Pham', degree: 'Bachelor of Science in Information Technology, Software Development', roles: ['Editorial & Technical Team', 'Deployment & Publishing'], social: {linkedin: 'https://www.linkedin.com/in/hungphamlk/'}},
